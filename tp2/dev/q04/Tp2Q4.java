...
class Ferramentas {
	...
	public static boolean gerarLog(double inic, double fim, int comp) {
		boolean resp = true;
		try {
			BufferedWriter bw = new BufferedWriter(new FileWriter(getMatricula() + "_binaria.txt"));
...
public class Tp2Q4 {
	...
	public static void main(String[] args) {
		...
		// procurando usando a pesquisa binária
		inic = listaFilmes.now();
		for (String ver : verificacoes) {
			results.add(listaFilmes.findBinario(ver));
