...
class Lista {
    ...
    /**
     * codigo de ordenação por mergesort em Java com Filmes
     */
    ...
    //Função para intercalar os resultados e realizar o mergeSort
    public void intercalar(int esq, int meio, int dir){
        ...
        a1[i] =  new Filme();
        a1[i].setOrcamento(9999999999f);
        a2[j] =  new Filme();
        a2[j].setOrcamento(9999999999f);
...
public class Tp3Q9 {
    ...
    public static void main(String[] args) {
        ...
        listaFilmes.mergeSort(0,entradas.size()-1);
        comp += listaFilmes.getComparacoes();
        mov += listaFilmes.getMovimentacoes();
        fim = listaFilmes.now();
        Ferramentas.gerarLog(inic, fim, comp, mov, "mergesort");
